...
@Component({
  ...
  templateUrl: './book-exchange-edit.component.html',
  styleUrls: ['./book-exchange-edit.component.css']
})
export class BookExchangeEditComponent implements OnInit, OnDestroy {
